var CLOSURE_UNCOMPILED_DEFINES = {"figwheel.repl.connect_url":"ws:\/\/localhost:9500\/figwheel-connect?fwprocess=72dbac&fwbuild=dev"};
...
document.write('<script>goog.require("test.preload");</script>');
